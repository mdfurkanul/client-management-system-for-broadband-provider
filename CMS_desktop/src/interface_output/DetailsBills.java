 ...
 * @author user
 */
public class DetailsBills extends javax.swing.JDialog {
    ...
    String Cid,tID,Wdate,Pdate,Ref,Amount,Via,Status;
    public DetailsBills(java.awt.Frame parent, boolean modal,String cid,String TID,String wdate,
            String pdate,String ref,String amount,String via,String status) {
        super(parent, modal);
        initComponents();
        ImageIcon img=new ImageIcon("img\\cms.png");
        this.setIconImage(img.getImage());
        Cid=cid;tID=TID;
        Wdate=wdate;Pdate=pdate;Ref=ref;Amount=amount;Via=via;Status=status;
                    model = (DefaultTableModel) view.getModel();
            
            String a[]={"Client ID          ",Cid};
            String b[]={"Transition         ",tID};
            String c[]={"Which month's bill ",Wdate};
            String d[]={"Paying Date        ",Pdate};
            String e[]={"Reference          ",Ref};
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            Logger.getLogger(DetailsBills.class.getName()).log(Level.SEVERE, null, ex);
        }
